    ...
    <>
      <div>
        ...
        {showReferralButton && !isModalOpen && (
          <button
            onClick={openModal}
            className="bg-[#7F3DFF] text-white py-3 px-4 rounded-full fixed bottom-20 right-4 hover:bg-purple-700 w-[20%] h-[45px] text-2xl flex left-[40%] z-40 items-center justify-center transition-all duration-300 transform hover:scale-105 max-sm:w-[25%] max-sm:left-[35%] max-[620px]:w-[25%]"
          >
